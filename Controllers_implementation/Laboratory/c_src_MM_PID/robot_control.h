...
public:
	void inicializa();
	mat matriz_inercia(double th1,double th2,double th3);
	mat matriz_coriolis(double th1,double th2,double th3,double th1d,double th2d,double th3d);
	mat matriz_gravedad(double th1,double th2,double th3);
	mat matriz_roce(double th1d,double th2d,double th3d);
