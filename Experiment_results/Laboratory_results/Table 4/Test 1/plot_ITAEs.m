...
for i=1:7
    ...
    err_cpc_sim_rot_base(i,:)=cpcref_sim(1,:,i)-cpcmed_sim(1,:,i);
    err_cpc_sim_pos_base(i,:)=cpcref_sim(2,:,i)-cpcmed_sim(2,:,i);
    err_cpc_sim_q1_brazo(i,:)=cpcref_sim(3,:,i)-cpcmed_sim(3,:,i);
    err_cpc_sim_q2_brazo(i,:)=cpcref_sim(4,:,i)-cpcmed_sim(4,:,i);
    err_cpc_sim_q3_brazo(i,:)=cpcref_sim(5,:,i)-cpcmed_sim(5,:,i);
...
N=length(itae_cpc_sim_qs_brazo(1,:));
for i=1:7
    clear aux_abs
    for j=1:N
...
for i=1:7
    clear abs_err_rot_base abs_err_pos_base abs_err_qs_brazo
    err_pd_sim_rot_base(i,:)=pdref_sim(1,:,i)-pdmed_sim(1,:,i);
    err_pd_sim_pos_base(i,:)=pdref_sim(2,:,i)-pdmed_sim(2,:,i);
    err_pd_sim_q1_brazo(i,:)=(pdref_sim(3,:,i)-pdmed_sim(3,:,i))/1;
    err_pd_sim_q2_brazo(i,:)=(pdref_sim(4,:,i)-pdmed_sim(4,:,i))/10;    %ACAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
    err_pd_sim_q3_brazo(i,:)=(pdref_sim(5,:,i)-pdmed_sim(5,:,i))/10;    %ACAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
...
for i=1:7
    clear abs_err_rot_base abs_err_pos_base abs_err_qs_brazo
    err_cpc_lab_rot_base(i,:)=cpcref_lab(1,:,i)-cpcmed_lab(1,:,i);
    err_cpc_lab_pos_base(i,:)=cpcref_lab(2,:,i)-cpcmed_lab(2,:,i);
    err_cpc_lab_q1_brazo(i,:)=cpcref_lab(3,:,i)-cpcmed_lab(3,:,i);
    err_cpc_lab_q2_brazo(i,:)=cpcref_lab(4,:,i)-cpcmed_lab(4,:,i);
    err_cpc_lab_q3_brazo(i,:)=cpcref_lab(5,:,i)-cpcmed_lab(5,:,i);
...
for i=1:7
    clear abs_err_rot_base abs_err_pos_base abs_err_qs_brazo
    err_pd_lab_rot_base(i,:)=pdref_lab(1,:,i)-pdmed_lab(1,:,i);
    err_pd_lab_pos_base(i,:)=pdref_lab(2,:,i)-pdmed_lab(2,:,i);
    err_pd_lab_q1_brazo(i,:)=pdref_lab(3,:,i)-pdmed_lab(3,:,i);
    err_pd_lab_q2_brazo(i,:)=pdref_lab(4,:,i)-pdmed_lab(4,:,i);
    err_pd_lab_q3_brazo(i,:)=pdref_lab(5,:,i)-pdmed_lab(5,:,i);
...
y1= itae_cpc_sim_pos_base;                                 % Create Dependent Variable ‘Experiments’ Data
y2= itae_pd_sim_pos_base;                              % Create Dependent Variable ‘Experiments’ Data
y3= itae_cpc_lab_pos_base;                                   % Create Dependent Variable ‘Experiments’ Data
y4= itae_pd_lab_pos_base;                               % Create Dependent Variable ‘Experiments’ Data
